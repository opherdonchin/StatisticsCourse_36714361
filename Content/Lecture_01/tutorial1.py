...
Original file is located at
    https://colab.research.google.com/drive/1xtZ72QNp76ionAgNLXCC-tU0loeq-pc5
...
from google.colab import files # colab file reader
import matplotlib.pyplot as plt # plot graphs
import pandas as pd # dataframes
import io # tools for stream-based input/output operations
...
# Note - for it to work for you you need to download the Google Sheet to Colab extention in Google Sheets.
#authentication
...
spreadsheet_id = '1arAtqgmDKWv1Cvz32n0J49LkSq9y7VJcCvGgbvq53wQ'  # Replace with your own spreadsheet ID
...
mean, var, skew, kurt = stats.skewnorm.stats(4, moments='mvsk') # generates statistics for a specific random variable
...
plt.plot([data_mode, data_mode] , [0, 0.8], color = 'blue', linewidth = 4,
           label = f'mode = {round(data_mode,2)}') # plots a line from (mean, 0) to (mean, 0.8)

plt.plot([data_median, data_median] , [0, 0.8], color = 'purple', linewidth = 4,
           label = f'median = {round(data_median,2)}') # # plots a line from (median, 0) to (median, 0.8)
...
# [We need at least 3 non-identical observations for stats.skew()
# and at least 4 non-identical observations for stats.kurtosis() to reliably return a number]
